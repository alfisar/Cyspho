$(document).ready(() => {
    ...
    $('#serviceEng').click(() => {
        $("#jenis").remove(); 
        $("#engSelect").append("<input id = 'jenis' type = 'hidden' name = 'jenis' value = 'enginer'>"); 
        selectEng();
        chooseEng();
    })
    ...
    $('#serviceMain').click(() => {
        $("#jenis").remove();
        $("#engSelect").append("<input id = 'jenis' type = 'hidden' name = 'jenis' value = 'Maintance'>"); 
        selectMain();
        chooseMain();
    })
    ...
    $('#serviceUnique').click(() => {
        $("#jenis").remove();
        $("#engSelect").append("<input id = 'jenis' type = 'hidden' name = 'jenis' value = 'Unique'>"); 
        selectUnique();
        chooseUnique();
    })
