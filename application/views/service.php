...
<body>
    ...
    <?php
            echo form_open("Service/data_service",$atribut);
    ?>
    <div class="mt-3 invisible">space from top</div>
    <div class="container-fluid mt-5">
        <h1 class="text-center">Services</h1>
        <div class="row justify-content-center mt-4">
            <div class="col-xl-3">
                <p class="numbering"><span>1</span>Select a Service</p>
            </div>
            <div class="col-xl-3">
            </div>
        ...
        <div class="row justify-content-center ">
            <div class="col-xl-3 text-center">
                <div id="serviceEng" class="service-card text-center">
                    <p>Engineering Services</p>
                </div>
            </div>
            <div class="col-xl-3 text-center">
                <div id="serviceMain" class="service-card">
                    <p>Maintenance Services</p>
                </div>
            </div>
            <div class="col-xl-3 text-center">
                <div id="serviceUnique" class="service-card">
                    <p>Unique Product</p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-xl-9">
                <div class="barrier mt-5"></div>
            </div>
        </div>
        <div class="row justify-content-center mt-5">
            <div class="col-xl-3 mt-3">
                <p class="numbering"><span>2</span>Choose a Product</p>
            </div>
            <div class="col-xl-3">
            </div>
            <div class="col-xl-3"></div>
    ...
    <!-- Product Selection -->
    <div id="engSelect" class="container-fluid hide">
        <div class="row justify-content-center ">
            <div class="col-xl-4 text-center">
                <select name = "Engineering" id="selectEngineering" class="custom-select mb-3">
                    <option value="tower">Tower</option>
                    <option value="colocation">Co-Location</option>
                    <option value="shelter">Shelter</option>
                    <option value="lab">IT Laboratorium</option>
                </select>
            </div>
    ...
    <div id="mainSelect" class="container-fluid hide">
        <div class="row justify-content-center">
            <div class="col-xl-4">
                <!-- <input type = 'hidden' name = 'jenis' value = 'maintance'> -->
                <div class="custom-control custom-radio mb-2">
                    <input type="radio" id="telcomMain" name="mainselect" class="custom-control-input mainSel"
                        checked="checked" value="telcom">
                    <label class="custom-control-label" for="telcomMain">Telecommunication Devices & support</label>
                </div>
                <div class="custom-control custom-radio mt-2">
                    <input type="radio" id="buildingMain" name="mainselect" class="custom-control-input mainSel"
                        value="building">
                    <label class="custom-control-label" for="buildingMain">Buildings & Infrastructures</label>
                </div>
            </div>
            <div class="col-xl-2 text-center">
            </div>
    ...
    <!-- Unique Selection -->
    <div id="uniqueSelect" class="container-fluid hide">
            <div class="row justify-content-center">
                    <div class="col-xl-4">
                        <div class="custom-control custom-radio mb-2">
                            <input type="radio" id="scadaUnique" name="uniqueselect" class="custom-control-input uniqueSel"
                                checked="checked" value="scada">
                            <label class="custom-control-label" for="scadaUnique">Scada System</label>
                        </div>
                        <div class="custom-control custom-radio mt-2">
                            <input type="radio" id="gpaUnique" name="uniqueselect" class="custom-control-input uniqueSel"
                                value="gpa">
                            <label class="custom-control-label" for="gpaUnique">General Purposes Agent</label>
                        </div>
                    </div>
                    <div class="col-xl-2 text-center">
                    </div>
    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-xl-3">
                <p class="numbering"><span>3</span>Product Information</p>
            </div>
            <div class="col-xl-3">
            </div>
            <div class="col-xl-3"></div>
        ...
        <!-- Product Services -->
        <div id="engServices" class="hide">
            <!-- Tower Selected -->
            <div id="enTower" class=" row justify-content-center hide">
                <div class=" col-xl-4">
                    <div class="row">
                        <div class="col-xl-5">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="towerSmall" name="customRadio" class="custom-control-input" value = 'Small'>
                                <label class="custom-control-label" for="towerSmall" >Small</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="towerMedium" name="customRadio" class="custom-control-input" value = 'Medium'>
                                <label class="custom-control-label" for="towerMedium" >Medium</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="towerLarge" name="customRadio" class="custom-control-input" value = 'Large'>
            ...
            <!-- Co-Location Selected -->
            <div id="enColocation" class="row justify-content-center hide">
                <div class="col-xl-6">
                    <div class="row">
                        <div class="col-xl-4">
                            <h5>Quantity</h5>
            ...
            <!-- Shelter Selected -->
            <div id="enShelter" class=" row justify-content-center hide">
                <div class=" col-xl-4">
                    <div class="row">
                        <div class="col-xl-6">
                            <!-- Radio button tower size -->
            ...
            <!--Lab Selected -->
            <div id="enLab" class="row justify-content-center hide">
                <div class="col-xl-6">
                    <div class="row">
                        <div class="col-xl-4">
                            <h5>Lab Capacity</h5>
        ...
        <div id="mainServices" class="hide">
            <!-- Telecom Selected -->
            <div id="mainTelcom" class=" row justify-content-center hide">
                <div class=" col-xl-9">
                    <div class="row">
                        <div class="col-xl-12">
                            <!-- Radio button tower size -->
            ...
            <div id="mainBuilding" class=" row justify-content-center hide">
                <div class=" col-xl-9">
                    <div class="row">
                        <div class="col-xl-12">
                            <!-- Radio button tower size -->
        ...
        <!-- Unique Services -->
        <div id="uniqueServices" class="hide">
                <!-- Telecom Selected -->
                <div id="uniqueScada" class=" row justify-content-center hide">
                    <div class=" col-xl-9">
                        <div class="row">
                            <div class="col-xl-12">
                                <!-- Radio button tower size -->
                ...
                <div id="uniqueGPA" class=" row justify-content-center hide">
                    <div class=" col-xl-9">
                        <div class="row">
                            <div class="col-xl-12">
                                <!-- Radio button tower size -->
    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-xl-3">
                <p class="numbering"><span>4</span>Customer Information</p>
            </div>
            <div class="col-xl-3">
            </div>
            <div class="col-xl-3"></div>
    ...
    <script src="<? echo base_url()?>assets/js/services.js"></script>
    <script>
        $('#datepicker').datepicker({
            uiLibrary: 'bootstrap4'
        });

        $('#datepickerCol').datepicker({
            uiLibrary: 'bootstrap4'
        });

        $('#datepickerShel').datepicker({
            uiLibrary: 'bootstrap4'
        });

        $('#datepickerLab').datepicker({
            uiLibrary: 'bootstrap4'
        });
    </script>
</body>
